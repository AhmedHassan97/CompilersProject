...
{
      21,     0,    -1,    22,    -1,    22,    23,    -1,    -1,    24,
      18,     3,    -1,    18,     4,    25,     3,    -1,    24,    18,
       4,    25,     3,    -1,     6,    -1,     7,    -1,     8,    -1,
       9,    -1,     5,    -1,    26,    -1,    27,    -1,    17,    -1,
      10,    -1,    11,    -1,    16,    -1,    15,    -1,    14,    -1,
      18,    -1,    27,    12,    27,    -1,    27,    13,    27,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    78,    78,    81,    82,    85,    93,   114,   136,   137,
     138,   139,   140,   142,   143,   144,   150,   156,   162,   170,
     178,   185,   186,   199
};
#endif
...
{
  "$end", "error", "$undefined", "SEMICOLON", "ASSIGN", "BOOL", "INT",
  "FLOAT", "CHAR", "STRING", "FALSE", "TRUE", "PLUS", "MINUS", "INTEGER",
  "FLOATNUMBER", "TEXT", "CHARACTER", "IDENTIFIER", "IFX", "$accept",
  "mystart", "startProgram", "stmt", "type", "expression", "DataTypes",
  "equalFamily", 0
};
#endif
...
{
       4,     0,     2,     1,    12,     8,     9,    10,    11,     0,
       3,     0,     0,     0,    16,    17,    20,    19,    18,    15,
      21,     0,    13,    14,     5,     0,     6,     0,     0,     0,
      22,    23,     7
};
...
{
     -10,    12,    -5,   -10,   -10,   -10,   -10,   -10,   -10,    19,
     -10,     6,     0,     4,   -10,   -10,   -10,   -10,   -10,   -10,
     -10,    22,   -10,     7,   -10,     0,   -10,    -9,    -9,    23,
       7,     7,   -10
};
...
{
       4,     5,     6,     7,     8,    16,    17,    24,    25,    20,
      14,    15,     3,     9,    16,    17,    18,    19,    20,    27,
      28,    30,    31,    12,    13,    26,    32,    29
};

static const yytype_uint8 yycheck[] =
{
       5,     6,     7,     8,     9,    14,    15,     3,     4,    18,
      10,    11,     0,    18,    14,    15,    16,    17,    18,    12,
      13,    27,    28,     4,    18,     3,     3,    25
};
...
{
       0,    21,    22,     0,     5,     6,     7,     8,     9,    18,
      23,    24,     4,    18,    10,    11,    14,    15,    16,    17,
      18,    25,    26,    27,     3,     4,     3,    12,    13,    25,
      27,    27,     3
};
...
#line 85 "yac.y"
    {
			// $$=NULL;
			// 1 type // 2 Identifier 
			CreateID((yyvsp[(1) - (3)].IntgerValue),(yyvsp[(2) - (3)].ID),IDCount++);
			printf("Declaration\n");
...
#line 94 "yac.y"
    {
			// $$=NULL;
			if(getSymbolType((yyvsp[(1) - (4)].ID))==(yyvsp[(3) - (4)].X)->Type)
			{
				...
				if(TempIsUsed){
					...
					setQuad(1,(yyvsp[(3) - (4)].X)->Value," ",(yyvsp[(1) - (4)].ID),QuadCount++);
				}
				TempCounter=0;
				TempIsUsed=false;
			}
			...
			if(checktypeIDENTIFER(getSymbolType((yyvsp[(2) - (5)].ID)),(yyvsp[(4) - (5)].X)->Type,(yyvsp[(2) - (5)].ID)))
			{
				...
				setQuad(0," "," ",(yyvsp[(2) - (5)].ID),QuadCount++);// Create  first IDENTIFIER
					if(TempIsUsed)
						...
						setQuad(1,(yyvsp[(4) - (5)].X)->Value," ",(yyvsp[(2) - (5)].ID),QuadCount++);
...
/* Line 1455 of yacc.c  */
#line 185 "yac.y"
    {(yyval.X)=(struct TypeAndValue*) malloc(sizeof(struct TypeAndValue));(yyval.X)->Type=getSymbolType((yyvsp[(1) - (1)].ID));(yyval.X)->Value=(yyvsp[(1) - (1)].ID);usedIDENTIFIER((yyvsp[(1) - (1)].ID));}
    break;
